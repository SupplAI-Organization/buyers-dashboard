...
export default function Hero() {
  return (
    <section
      id="hero"
      className="relative bg-[#F6F7F9] overflow-hidden min-h-[700px] md:min-h-[800px] scroll-mt-16"
    >
      {/* FULL WIDTH IMAGE */}
      ...
      <div className="max-w-7xl mx-auto px-6 py-20 md:py-28 relative z-10">
        ...
        <div className="max-w-xl">
          ...
          <p className="mt-6 text-lg md:text-xl text-gray-600 leading-relaxed max-w-md">
            SupplAI removes confusion from procurement by connecting you with{" "}
          ...
          <div className="mt-10 flex flex-col sm:flex-row items-start sm:items-center gap-4">
            <Link
              href="/login"
              className="group bg-[#EA7B7B] hover:bg-[#d96a6a] text-white px-8 py-4 rounded-full font-semibold transition-all duration-300 shadow-lg shadow-[#EA7B7B]/25 hover:shadow-xl hover:shadow-[#EA7B7B]/30 hover:-translate-y-0.5"
            >
              Get Started
