...
const steps = [
  {
    ...
    description: "Search verified suppliers by category, location, or product type.",
    objectPosition: "center bottom", // Crop white part from top
  },
  {
    title: "Compare Specs",
    description: "View detailed product specifications and pricing side by side.",
    objectPosition: "center bottom", // Crop white part from top
  },
  {
    title: "Place Orders",
  ...
  },
  {
    ...
    description: "Monitor your orders and manage your supply chain in real-time.",
    objectPosition: "center center",
  },
];
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-5 md:gap-6 mt-12 max-w-4xl mx-auto">
        {landingImages.steps.map((img, i) => (
          <div key={i} className="text-center">
            ...
            <h3 className="font-medium text-gray-900 text-sm">{steps[i]?.title}</h3>
